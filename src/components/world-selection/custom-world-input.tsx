...
export function CustomWorldInput({
  ...
  return (
    <div className="border-zinc-800 border-t pt-6">
      ...
      <Textarea
        className="border! min-h-32 resize-none rounded-none border-zinc-800! bg-zinc-900/30! font-mono text-sm text-zinc-300 placeholder:text-zinc-600 focus:border-primary! focus:outline-none! focus:ring-1! focus:ring-primary/20! disabled:cursor-not-allowed disabled:opacity-50"
        disabled={disabled}
