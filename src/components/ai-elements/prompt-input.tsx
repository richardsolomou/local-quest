...
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@ras-sh/ui/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@ras-sh/ui/select";
...
const subscribeToSpeechRecognition = () => () => undefined;
...
export const PromptInputSpeechButton = ({
  ...
  }, [textareaRef, onTranscriptionChange, recognitionSupported]);
